...
use backend\models\search\ApartmentsSearch;
use Yii;
...
/**
 * AraptmentsController implements the CRUD actions for Apartments model.
 */
class ApartmentsController extends Controller
{
    ...
    {
        $model = $this->findModel($id);
        $file = $model->getPath(Apartments::UPLOAD_PATH, $model->image);
